...
//-----------------------------------------------------------------------------
int WifiNetworkModel::rowCount(const QModelIndex& i_parent /*= QModelIndex()*/) const {
    Q_UNUSED(i_parent);
...
//-----------------------------------------------------------------------------
void WifiNetworkModel::setConnectionStatus(const QString& i_networkName, WifiNetwork::ConnectionStatus i_connectionStatus) {
